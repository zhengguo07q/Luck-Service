...
public interface StatisticsService
{
	...
	/**
	 * Converts given {@link Account} object to {@link DataPoint} with a set of
	 * significant statistic metrics.
	 *
	 * Compound {@link DataPoint#id} forces to rewrite the object for each

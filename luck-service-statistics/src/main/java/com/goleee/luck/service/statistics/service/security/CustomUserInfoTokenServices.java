package com.goleee.luck.service.statistics.service.security;
...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices
{
	...
	private OAuth2Request getRequest(Map<String, Object> map)
	{
		...
		Set<String> scope = new LinkedHashSet<String>(request.containsKey("scope") ? (Collection<String>) request.get("scope")
				: Collections.<String> emptySet());

		return new OAuth2Request(null, clientId, null, true, new HashSet<String>(scope), null, null, null, null);
	}
